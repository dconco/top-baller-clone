const menuBtn: Object<HTMLDivElement> = document.getElementById('menu-btn')!
const navLinks: Object<HTMLDivElement> = document.getElementById('nav-links')!
const navEvents: Object<HTMLCollection> =
	document.getElementsByClassName('nav-events')!
